    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white tracking-tight italic">TaskFlow</h1>
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-white/10 p-8 md:p-10 rounded-[2.5rem] shadow-2xl">
          <form onSubmit={handleAuth} className="space-y-5">
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full bg-slate-950/50 border border-white/5 focus:border-indigo-500 pl-12 pr-4 py-4 rounded-2xl outline-none text-white text-sm transition-all"
          ...
          <div className="mt-8 pt-8 border-t border-white/5 text-center">
            ...
            <button onClick={() => setIsRegistering(!isRegistering)} className="mt-2 text-indigo-400 hover:text-indigo-300 font-black text-sm transition-all uppercase">
